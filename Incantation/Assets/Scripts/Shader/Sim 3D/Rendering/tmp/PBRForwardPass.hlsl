// JWB Inverse functions of depth linearization
...
half4 frag(PackedVaryings packedInput, out float depth : SV_Depth) : SV_TARGET
{
    ...
    // JWB Depth Override from Alpha Clip Threshold
    depth = LinearDepthToNonLinear(surfaceDescription.AlphaClipThreshold, _ZBufferParams);
